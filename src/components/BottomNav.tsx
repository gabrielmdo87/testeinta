...
const BottomNav = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-background border-t border-border/30 px-6 py-2.5">
      <div className="flex items-center justify-between max-w-md mx-auto">
        ...
        <button className="p-1">
          <img
            src={avatarMain}
            alt="Profile"
            className="w-7 h-7 rounded-full object-cover ring-2 ring-foreground"
          />
        </button>
      </div>
    </nav>
